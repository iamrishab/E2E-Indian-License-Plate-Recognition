...
def master_evaluation(choice, gt_zip_path, submit_zip_path, json_schema):
    ...
    result = rrc_evaluation_funcs.main_evaluation(args, default_evaluation_params, validate_data,
                                         evaluate_method)
